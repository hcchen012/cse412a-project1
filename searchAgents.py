    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                successorState = ((next_position, visited_corners), action, 1)
...
def cornersHeuristic(state, problem):
    ...
    while len(unvisited_corners) > 0:
        ...
        for i in unvisited_corners:
            distance = abs( i[0] - currPosition[0] ) + abs( i[1] - currPosition[1])
            if heuristic == 0 or distance < heuristic:
                heuristic = distance # set heuristic to the min distance
                corner = i
...
def foodHeuristic(state, problem):
    ...
    for food in foodPosition:
        #distanceH.append(manhattanDistance(position, food))
        distanceH.append(mazeDistance(position, food, problem.startingGameState))
    return max(distanceH) 
